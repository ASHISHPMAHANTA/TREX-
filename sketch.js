...
var obstaclesGroup, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6,Background,BackgroundImage;
...
function preload(){
  ...
  cloudImage = loadImage("Cloud.jpeg");
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(320,400));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,1050,10,40);
    //obstacle.debug = true;
